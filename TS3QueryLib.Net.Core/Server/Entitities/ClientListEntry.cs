...
{
    public class ClientListEntry : IEntity<ClientListEntry>
    {
        #region Properties
        ...
        ClientListEntry IEntity<ClientListEntry>.ApplyFrom(CommandParameterGroup currentParameterGroup, CommandParameterGroup firstParameterGroup)
        {
