...
namespace TS3QueryLib.Net.Core.Server.Entitities
{
    public class PermissionOverviewEntry : IEntity<PermissionOverviewEntry>
    {
        ...
        PermissionOverviewEntry IEntity<PermissionOverviewEntry>.ApplyFrom(CommandParameterGroup currentParameterGroup, CommandParameterGroup firstParameterGroup)
        {
